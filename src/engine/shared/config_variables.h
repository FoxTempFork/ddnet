...
MACRO_CONFIG_STR(ClRegisterProxy, cl_register_proxy, 256, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "HTTP/SOCKS5 proxy for HTTP serverlist requests (e.g. http://127.0.0.1:8080, socks5://127.0.0.1:9050)")
